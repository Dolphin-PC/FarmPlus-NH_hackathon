import { Accordion, AccordionDetails, AccordionSummary, InputLabel } from "@material-ui/core";
...
const ContractAccordionComp = ({ product, requester }) => {
  return (
    <Accordion>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>계약서 내용 확인</AccordionSummary>
      <AccordionDetails>
        <div style={{ width: "100%" }} className="font-Spoqa">
          <div className="Row" style={{ border: "1px solid lightgray", padding: 10 }}>
            <div className="col-xs-2 text-center" style={{ writingMode: "vertical-rl" }}>
              매도인(갑)
            </div>
