      ...
      <div className="Row" style={{ marginTop: 10 }}>
        ...
        <div onClick={handleNoticeClick} style={{ marginTop: 10 }}>
          ...
          <div className="Row" style={{ justifyContent: "space-between", marginTop: 8 }}>
            ...
            {noticeType === "거래진행" ? <small style={{ color: "lightgray" }}>[거래해약]</small> : ""}
          </div>
        </div>
        <RequesterInfoDialog open={openRequesterInfoDialog} onClose={() => setOpenRequesterInfoDialog(!openRequesterInfoDialog)} {...props} />
        <ContractDialog open={openContractDialog} onClose={() => setOpenContractDialog(!openContractDialog)} {...props} />
        <CompleteDialog open={openCompleteDialog} onClose={() => setOpenCompleteDialog(!openCompleteDialog)} {...props} />
      </div>
    </div>
  );
};
